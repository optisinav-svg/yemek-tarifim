...
export default function ProfileScreen() {
  ...
  return (
    <ScreenContainer className="px-5" edges={["top", "left", "right"]}>
      ...
      <View style={[styles.profileCard, { backgroundColor: colors.surface, borderColor: colors.border }]}><View style={[styles.avatar, { backgroundColor: colors.primary }]}><Text style={styles.avatarText}>YK</Text></View><View style={styles.profileText}><Text style={[styles.name, { color: colors.foreground }]}>Yemek dostu</Text><Text style={[styles.email, { color: colors.muted }]}>Profilini kişiselleştir</Text></View><IconSymbol name="chevron.right" size={19} color={colors.muted} /></View>
      ...
      <View style={styles.security}><IconSymbol name="check" size={17} color={colors.success} /><Text style={[styles.securityText, { color: colors.muted }]}>Verilerin cihazında güvenle saklanır.</Text></View>
    </ScreenContainer>
  );
}
